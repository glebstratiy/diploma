...
const generateAccessToken = (id, username, password, appointments) => {
    const payload = {
        id,
        username,
        password,
...
exports.doLogin = async(req, res) => {
    try {
        ...
        const token = generateAccessToken(fetchuser._id, fetchuser.username, fetchuser.password, fetchuser.appointments)
